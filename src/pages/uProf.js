...
import FormUpdateProfessor from "../components/AuthPages/FormuProfessor";
        ...
        <>
            ...
            <PanelStyle>
                ...
                <Container maxWidth="md" className="form_Container">
                    <Typography align="center" gutterBottom={true} variant="h4">ویرایش اطلاعات استاد</Typography>
